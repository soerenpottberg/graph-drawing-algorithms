...
import org.pottberg.gda.tree.algorithms.LayeredTreeAlgorithm;
...
public class GraphDrawingAlgorithmsController {
	...
	BinaryTree<SimpleBinaryTreeNode> tree = createBinaryTree(
		...
		.addLeftChild(createBinaryTreeNode(1l)
			...
			.addLeftChild(createBinaryTreeNode(121l)
			    .addLeftChild(createBinaryTreeNode(1211l)
				.addLeftChild(12111l)
				.addRightChild(12112l))
			    .addRightChild(createBinaryTreeNode(1212l)
				.addLeftChild(12121l)
				.addRightChild(12122l)))
			.addRightChild(createBinaryTreeNode(122l)
			    .addLeftChild(createBinaryTreeNode(1221l)
				.addLeftChild(12211l)
				.addRightChild(12212l))
			    .addRightChild(createBinaryTreeNode(1222l)
				.addLeftChild(12221l)
				.addRightChild(12222l))
			)
		    )
		)
		.addRightChild(createBinaryTreeNode(2l)
		    .addLeftChild(createBinaryTreeNode(21l)
			.addLeftChild(211l)
			.addRightChild(212l))
		    .addRightChild(createBinaryTreeNode(22l)
			.addLeftChild(221l)
			.addRightChild(222l))
		)
	    );
	...
	algorithms.add(new LayeredTreeAlgorithm<SimpleTreeNode>(tree));
	algorithms.add(new SimpleTreeAlgorithm(tree));
